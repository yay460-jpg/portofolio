...
*Dokumen ini disusun dari sesi kerja GeoPDF Coordinate Engine, 5-6 September 2026. Untuk detail partisi awal `member-app/` (7 tahap, sebelum GeoPDF), lihat [`panduan-partisi-member-android.md`](Member_Android_Partition.md).*
