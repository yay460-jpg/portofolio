# MG1 / LITHOSITE — V23 — No-Modal-Flicker / Management Isolation
...
Global render menyebabkan modal flicker dan management path bercampur.

## 2. Feature / Requirement

- No-render open/close
- Isolated management modal
- Atomic activate/delete helpers

## 3. Alur Utama

```text
Management open/close → DOM only; activate/delete → atomic surface swap
```

## 4. Struktur / Arsitektur Sebelum

```text
Management masih render-coupled.
```

## 5. Struktur / Arsitektur Sesudah

```text
Management modal isolated; runtime surface swap tetap V22.
```
...
> **Management UI dipisahkan dari render lifecycle.**
