# MG1 / LITHOSITE — V14.31 — C2 Auto Visible Field Test
...
Planner dan renderer perlu dibandingkan secara repeatable.

## 2. Feature / Requirement

- Automatic controlled C2 field test

## 3. Alur Utama

```text
C1 Visible ↔ C2 Planned / Rendered
```

## 4. Struktur / Arsitektur Sebelum

```text
Testing lebih manual.
```

## 5. Struktur / Arsitektur Sesudah

```text
C2 otomatis untuk controlled field testing.
```
...
> **Planner dan renderer mulai dapat dibandingkan secara repeatable.**
