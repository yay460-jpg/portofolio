# MG1 / LITHOSITE — V19 — Isolated Map Modal

**Status:** LOCKED COMPATIBILITY  
**Progress versi:** **100%**  
...
Global render dapat menyebabkan modal flicker.

## 2. Feature / Requirement

- Isolated new map modal
- No-flicker modal path

## 3. Alur Utama

```text
Open modal → isolated DOM modal → no global render dependency
```

## 4. Struktur / Arsitektur Sebelum

```text
Modal terlalu dekat dengan global render lifecycle.
```

## 5. Struktur / Arsitektur Sesudah

```text
Modal mempunyai lifecycle DOM terisolasi; menjadi foundation untuk V23/V24.3.
```
...
**Status validasi:** LOCKED COMPATIBILITY
...
> **Awal pemisahan modal lifecycle dari rendering.**
