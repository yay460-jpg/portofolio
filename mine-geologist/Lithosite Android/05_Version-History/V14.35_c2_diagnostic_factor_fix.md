# MG1 / LITHOSITE — V14.35 — C2 Diagnostic Factor Fix
...
Diagnostic factor tidak mencerminkan actual LOW factor.

## 2. Feature / Requirement

- Actual factor reporting fix

## 3. Alur Utama

```text
Actual C2 factor → diagnostic
```
...
```text
Diagnostic reporting diperbaiki ke actual 1x.
```
...
> **Observability disinkronkan dengan runtime.**
