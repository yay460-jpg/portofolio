# MG1 / LITHOSITE — V14.24 — Device Profiler V2
...
Benchmark single/kurang stabil kurang representatif.

## 2. Feature / Requirement

- 512×512 raster/compositing benchmark
- Warm-up
- Multiple samples
- Median result
...
```text
Warm-up → multiple samples → median
```

## 4. Struktur / Arsitektur Sebelum

```text
Benchmark belum cukup stabil.
```

## 5. Struktur / Arsitektur Sesudah

```text
Profiling menggunakan benchmark raster/compositing dan median.
```
...
> **Device measurement dibuat lebih representatif.**
