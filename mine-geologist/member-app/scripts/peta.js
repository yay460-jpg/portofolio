      ...
      if (pyramid && Array.isArray(pyramid.levels) && pyramid.levels.length) {
        ...
        try {
          ...
          if (pyramid && detailLevel) {
            ...
            let approvedSelection = { ok:false, selectedKeys:[], visibleKeys:[], prefetchKeys:[], selectedCount:0, visibleCount:0, floor:50, maxTiles:null, conflict:true, reason:'selection-not-run' };
            if (visibleResult.ok) {
              ...
              approvedSelection = (typeof selectLithositeQualityWithGuard_ === 'function')
                ? selectLithositeQualityWithGuard_(visibleResult.keys, detailLevel, engineProfile, { qualityFloor:50, maxExpansionRadius:20 })
                : approvedSelection;
              try { if (typeof window !== 'undefined') window.mg1LastApprovedTileSelection = approvedSelection; } catch(_) {}
            ...
            if (visibleResult.ok && approvedSelection.selectedKeys.length) {
