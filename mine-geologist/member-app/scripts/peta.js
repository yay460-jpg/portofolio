...
function showDeviceTileProfileDiagnostic_(profile) {
  try {
    ...
    launcher.style.cssText = [
      ...
      'color:#7dd3fc',
      'font:16px/32px -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif',
      'text-align:center',
    ...
    launcher.addEventListener('click', openProfiler);
    launcher.addEventListener('touchend', function (ev) { ev.preventDefault(); openProfiler(); }, { passive:false });
    close.addEventListener('click', closeProfiler);
